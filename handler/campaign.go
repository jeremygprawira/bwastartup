...
func (h *campaignHandler) GetCampaign(c *gin.Context) {
	...
	response := helper.APIResponse("Campaign detail", http.StatusOK, "success", campaign.FormatCamapignDetail(campaignDetail))
	c.JSON(http.StatusOK, response)
}
...
func (h *campaignHandler) CreateCampaign(c *gin.Context) {
	...
	response := helper.APIResponse("Sucess to create campaign", http.StatusOK, "success", campaign.FormatCampaign(newCampaign))
	c.JSON(http.StatusOK, response)
}
...
func (h *campaignHandler) UpdloadImage(c *gin.Context) {
	...
	response := helper.APIResponse("Campaign image is successfuly uploaded", http.StatusOK, "success", data)
	c.JSON(http.StatusOK, response)
}
